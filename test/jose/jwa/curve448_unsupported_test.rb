...
class JOSE::JWA::Curve448_UnsupportedTest < Minitest::Test
  ...
  def test_unsupported_methods
    [
      [:ed448_keypair, EdDSA_SECRET],
      [:ed448_secret_to_public, EdDSA_SK],
      [:ed448_sign, EdDSA_M, EdDSA_SK],
      [:ed448_verify, Ed448_SIGNATURE, EdDSA_M, EdDSA_PK],
      [:ed448ph_keypair, EdDSA_SECRET],
      [:ed448ph_secret_to_public, EdDSA_SK],
      [:ed448ph_sign, EdDSA_M, EdDSA_SK],
      [:ed448ph_verify, Ed448ph_SIGNATURE, EdDSA_M, EdDSA_PK],
      [:x448_keypair, Curve448_SECRET],
      [:x448_secret_to_public, Curve448_SECRET],
      [:x448_shared_secret, Curve448_PUBLIC, Curve448_SECRET]
    ].each do |(function, *args)|
      assert_raises(NotImplementedError) { JOSE::JWA::Curve448_Unsupported.send(function, *args) }
    end
  end
