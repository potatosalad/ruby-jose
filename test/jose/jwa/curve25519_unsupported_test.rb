...
class JOSE::JWA::Curve25519_UnsupportedTest < Minitest::Test
  ...
  def test_unsupported_methods
    [
      [:ed25519_keypair, EdDSA_SECRET],
      [:ed25519_secret_to_public, EdDSA_SK],
      [:ed25519_sign, EdDSA_M, EdDSA_SK],
      [:ed25519_verify, Ed25519_SIGNATURE, EdDSA_M, EdDSA_PK],
      [:ed25519ph_keypair, EdDSA_SECRET],
      [:ed25519ph_secret_to_public, EdDSA_SK],
      [:ed25519ph_sign, EdDSA_M, EdDSA_SK],
      [:ed25519ph_verify, Ed25519ph_SIGNATURE, EdDSA_M, EdDSA_PK],
      [:x25519_keypair, Curve25519_SECRET],
      [:x25519_secret_to_public, Curve25519_SECRET],
      [:x25519_shared_secret, Curve25519_PUBLIC, Curve25519_SECRET]
    ].each do |(function, *args)|
      assert_raises(NotImplementedError) { JOSE::JWA::Curve25519_Unsupported.send(function, *args) }
    end
  end
